...
CONFIG = {'freq_min': 1.0, 'freq_max': 8000.0}
MODEL_CFG = {
    'encoder_type': 'modal',
    'encoder_kwargs': {'coord_dim':3, 'point_feat_dim':6, 'hidden_dim':256,
                       'n_modes':2, 'trunk_layers':4, 'branch_layers':2,
                       'siren_w0':30.0, 'amp_scale':500000.0, 'branch_hidden_dim':64,
